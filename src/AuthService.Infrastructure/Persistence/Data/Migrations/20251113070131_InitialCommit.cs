        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExternalLogins_ApplicationUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "3f9c1e3d-8b7a-4e6f-9c2e-2a1f4d8e9b6c", new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Administrator role with full access", "Admin", "ADMIN", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "7a2d4f1c-3e8b-4c9f-bd3a-5e2c9a7f1d4e", new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Standard user role", "User", "USER", null }
                });
